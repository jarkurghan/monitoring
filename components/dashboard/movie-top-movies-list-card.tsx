...
interface MovieTopMoviesListCardProps {
    data: MovieTopMovie[];
}

export function MovieTopMoviesListCard({ data }: MovieTopMoviesListCardProps) {
    return (
        <Card className="bg-card border-border h-full">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-base font-medium">Top multfilmlar</CardTitle>
            </CardHeader>
