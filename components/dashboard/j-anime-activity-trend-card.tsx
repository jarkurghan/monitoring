...
import { AnimeTotalUsers } from "@/services/anime";

interface AnimeActivityTrendCardProps {
    data: AnimeTotalUsers[];
}

export function AnimeActivityTrendCard({ data }: AnimeActivityTrendCardProps) {
